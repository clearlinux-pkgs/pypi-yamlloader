...
pushd ..
cp -a yamlloader-1.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656360673
...
cp %{_builddir}/yamlloader-1.1.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-yamlloader/d614df4a8ba8b9abcbd7464585398394394797c4
